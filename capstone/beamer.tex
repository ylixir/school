...
A fiber is the set of vectors associated with each element of our NSG.
\pause
\begin{example}
\begin{align*}
\mathcal{F}(12)&=\{(1,1,0)\}\\
...
\end{frame}
\begin{frame}
It may be easier to think of a fiber as a graph.
\begin{example}
$\mathcal{F}(14)=\{(1,0,1),(0,2,0)\}$:\\
...
We have an easy bijection between our Markov basis and an integer lattice ideal.
\pause
\begin{example}
\[
