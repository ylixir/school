...
\item
  ...
  \item
    ...
    Well $\sup A\ge \inf A$ and so $\inf A\le \sup A-\frac{1}{n}\inf A\le \sup A$ for all $n\in \mathbb{N}\setminus\{0\}$.
    Lets just define $a_n=\sup A-\frac{1}{n}\inf A$ and notice that every $a_n\in A$ and $\lim\limits_{n\to\infty}a_n=\sup A$.
    Similarly $\inf A\le \inf A+\frac{1}{n}\sup A\le \sup A$.
    If we define $b_n=\inf A+\frac{1}{n}\sup A$ then every $b_n\in A$ and $\lim\limits_{n\to\infty}b_n=\inf A$.
