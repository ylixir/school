...
\item
  ...
  \item
    ...
    Well $\sup A\ge \inf A$ and so $\inf A\le a_n=\sup A-\frac{1}{n}(\sup A-\inf A)\le \sup A$ for all $n\in \mathbb{N}\setminus\{0\}$.
    Notice that $a_n\in A$ for all $n$ and $\lim\limits_{n\to\infty}a_n=\sup A$.
    Similarly $\inf A\le b_n=\inf A+\frac{1}{n}(\sup A-\inf A)\le \sup A$.
